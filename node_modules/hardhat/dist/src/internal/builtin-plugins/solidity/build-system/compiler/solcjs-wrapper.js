...
export default function wrapper(solc) {
    ...
    if (compile === undefined) {
        throw new HardhatError(HardhatError.ERRORS.CORE.SOLIDITY.INVALID_SOLCJS_COMPILER, {
            version: version(),
        });
    }
    return {
...
function compileWrapper(isVersion6OrNewer, compile, reset) {
    return (input) => {
...
//# sourceMappingURL=solcjs-wrapper.js.map